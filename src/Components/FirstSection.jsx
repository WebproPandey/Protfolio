  ...
  return (
    <div className=" w-full py-[3rem] flex flex-col gap-2 ">
      ...
      <div className="w-full md:w-[70%]">
        <p className="text-[#998f8f] poppins-thik  text-[16px] md:text-[19px] leading-[20px] md:leading-[25px]">
      ...
      <div className="showcasecart w-full md:w-[80%] pt-[3rem] flex md:flex-row flex-col gap-4  ">
        <div className="leftcart  w-full  md:w-[40%]  h-[40vh]  bg-[#F46C38] rounded-2xl overflow-hidden relative  ">
        ...
        <div className="rightcart w-full md:w-[60%] h-[40vh] bg-[#C5FF41] rounded-2xl overflow-hidden relative ">
